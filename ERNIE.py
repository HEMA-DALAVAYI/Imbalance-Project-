...
# 4. Train the ERNIE model
tokenizer = AutoTokenizer.from_pretrained('nghuyong/ernie-2.0-en')

train_encodings = tokenizer(train_x, truncation=True, padding=True, max_length=128)
eval_encodings = tokenizer(test_x, truncation=True, padding=True, max_length=128)
...
model = AutoModelForSequenceClassification.from_pretrained('nghuyong/ernie-2.0-en', num_labels=2)
...
male_eval_encodings = tokenizer(male_x_reviews, truncation=True, padding=True, max_length=128)
female_eval_encodings = tokenizer(female_x_reviews, truncation=True, padding=True, max_length=128)
